...
\author{Kyrylo Kolesnichenko$^{1,2}$, Irvin Steve Cardenas$^{2}$, and Jong-Hoon Kim$^{2}$% <-this % stops a space
%\thanks{*This work was supported by Advanced Telerobotics Research Lab, Kent State University}% <-this % stops a space
